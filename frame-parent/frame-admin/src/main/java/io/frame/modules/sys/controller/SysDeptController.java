...
public class SysDeptController extends AbstractController {
	...
	public List<SysDept> list(SysDept sysDept) {
		return sysDeptService.querySysDeptList(sysDept);
	}
	...
	public R select(SysDept sysDept) {
		List<SysDept> deptList = sysDeptService.querySysDeptList(sysDept);

		// 添加一级部门
		if (getSuperUser() == Constant.SUPER_ADMIN) {
