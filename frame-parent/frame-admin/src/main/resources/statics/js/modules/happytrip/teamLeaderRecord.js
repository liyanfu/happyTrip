$(function () {
	...
	tableOption.cols = [[
        ...
        {field:'recommendNum', 		minWidth:100,   title: '当日达标人数', sort: true},
        {field:'achievement', 		minWidth:100,   title: '当日团队业绩', sort: true},
	...
	tableOption.url = baseURL + 'ht/teamleaderrecord/list';
	//初始化表格
    ...
    methods: {
        ...
        grant: function (ids) {
        	...
        	if(ids == null){
        	  ...
        	  confirm('确定要发放选中的记录？', function(){
                  $.ajax({
                      type: "POST",
                      url: baseURL + "ht/teamleaderrecord/grant",
        ...
        del: function (id) {
            ...
            confirm('确定要删除选中的记录？', function(){
                $.ajax({
                    type: "POST",
                    url: baseURL + "ht/teamleaderrecord/delete",
                    data: {id:id},
                    success: function(r){
                        if(r.code === 0){
                            alert('操作成功', function(){
