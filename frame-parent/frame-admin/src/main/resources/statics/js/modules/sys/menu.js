    ...
    methods: {
        getMenu: function(){
            ...
            $.get(baseURL + "sys/menu/select", function(r){
                ...
                vm.menu.map.parentName = node.name;
            })
        },
        add: function(){
            vm.menu = {map:{parentName:null},parentId:0,type:1,orderNum:0};
            vm.getMenu();
        ...
        menuTree: function(){
            layer.open({
                ...
                btn1: function (index) {
                    ...
                    vm.menu.map.parentName = node[0].name;
...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '上级菜单', field: 'parentName', align: 'center', valign: 'middle', sortable: true, width: '100px',formatter: function(item, index){
         	return item.map.parentName==null?"":item.map.parentName;
        }},
        {title: '图标', field: 'icon', align: 'center', valign: 'middle', sortable: true, width: '80px', formatter: function(item, index){
            return item.icon == null ? '' : '<i class="icon '+item.icon+' fa-lg"></i>';
        }},
