    ...
    methods: {
        getDept: function(){
            ...
            $.get(baseURL + "sys/dept/select", function(r){
                ...
                vm.dept.map.parentName = node.name;
            })
        },
        add: function(){
            vm.dept = {map:{parentName:null},parentId:0,orderNum:0};
            vm.getDept();
        ...
        deptTree: function(){
            layer.open({
                ...
                btn1: function (index) {
                    ...
                    vm.dept.map.parentName = node[0].name;
...
Dept.initColumn = function () {
    var columns = [
        ...
        {title: '上级部门', field: 'parentName', align: 'center', valign: 'middle', sortable: true, width: '100px',  formatter: function(item, index){
