$(function () {
	...
	tableOption.cols = [[
        ...
        {field:'alipayName', 		minWidth:100,   title: '支付宝名称', sort: true},
        {field:'alipayMobile', 		minWidth:100,   title: '支付宝账号', sort: true},
        {field:'rechargeCode', 		minWidth:100,   title: '充值凭证吗', sort: true},
...
//格式化状态
var formatterRechaegeStatus = function(d){
