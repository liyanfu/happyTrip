...
public interface CustomeRecommendMapper {
	 ...
	 * the database table u_recommend
	 *
	 * @mbggenerated
	 */
	 ...
	 * @mbggenerated
	 */
	Recommend selectByPrimaryKeyShowField(@Param("showField") List<String> showField,
	 ...
	 * @mbggenerated
	 */
	List<Recommend> selectByExampleShowField(@Param("showField") List<String> showField,
	 ...
	 * @mbggenerated
	 */
	Recommend selectOneByExampleShowField(@Param("showField") List<String> showField,
			@Param("example") RecommendExample example);
