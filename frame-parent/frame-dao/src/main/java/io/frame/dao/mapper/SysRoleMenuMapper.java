...
public interface SysRoleMenuMapper {
     ...
     * @mbggenerated
     */
    int insertBatchSelective(@Param("showField") List<String> showField, @Param("list") List<SysRoleMenu> list);
     ...
     * @mbggenerated
     */
    SysRoleMenu selectByPrimaryKeyShowField(@Param("showField") List<String> showField, @Param("id") Long id);
     ...
     * @mbggenerated
     */
    int updateByExampleSelectiveSync(@Param("record") SysRoleMenu record, @Param("example") SysRoleMenuExample example);
     ...
     * @mbggenerated
     */
    int upsertSelective(SysRoleMenu record);
}