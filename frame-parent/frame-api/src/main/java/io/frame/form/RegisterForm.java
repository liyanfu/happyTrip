...
public class RegisterForm {
	...
	@ApiModelProperty(value = "支付宝名称", position = 4, required = true)
	@NotBlank(message = "支付宝名称不能为空")
	private String alipayName;

	@ApiModelProperty(value = "支付宝账号", position = 4, required = true)
	@NotBlank(message = "支付宝账号不能为空")
	private String alipayMobile;

	@ApiModelProperty(value = "推荐人账号", position = 4, required = true)
	@NotBlank(message = "推荐人账号")
